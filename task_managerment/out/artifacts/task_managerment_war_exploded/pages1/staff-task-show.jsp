					...
					<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc">计划名称</th>
										<th class="sorting_desc">完成状态</th>
										<th class="sorting_asc sorting_asc_disabled">是否反馈</th>
										<th class="sorting_desc sorting_desc_disabled">开始时间</th>
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}" class="btn bg-olive btn-xs">新建</a>
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}" class="btn bg-olive btn-xs">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
