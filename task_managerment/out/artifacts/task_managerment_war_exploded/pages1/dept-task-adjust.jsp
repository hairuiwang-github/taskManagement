...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/deptAdjustSaveServlet"
				method="post">
				<!-- 正文区域 -->
				...
				<div class="panel panel-default">
					<div class="panel-heading">调整任务信息</div>
					<div class="row data-type">

						<div class="col-md-2 title">任务名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="task_name"
								placeholder="任务名称" value="${map.task_name}">
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="task_description"
								placeholder="任务描述" value="${map.task_description}">
						</div>
