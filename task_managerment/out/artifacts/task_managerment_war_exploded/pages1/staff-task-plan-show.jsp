...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				任务管理 <small>查询任务</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/pages1/staff-main.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a href="${pageContext.request.contextPath}/pages1/staff-main.jsp">任务管理</a></li>
				...
				<c:forEach items="${planList}" var="plan" varStatus="status">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data text">
							<a href="${pageContext.request.contextPath}/staffFeedbackBeforeServlet?id=${plan.id}" class="btn bg-olive btn-xs">反馈计划</a>
							<a href="${pageContext.request.contextPath}/staffDeletePlanServlet?id=${plan.id}" class="btn bg-olive btn-xs">删除计划</a>
						</div>
					</div>
				</c:forEach>
